...
public class BaseResult implements Serializable {
    ...
    public static BaseResult success(String message, Object data,Integer count) {
        return BaseResult.createResult(STATUS_SUCCESS, message, data,count);
    }
    ...
    private static BaseResult createResult(int status, String message, Object data,Integer count) {
        BaseResult baseResult = new BaseResult();
        baseResult.setStatus(status);
        baseResult.setMessage(message);
        baseResult.setData(data);
