...
public class VisitController extends AbstractController<VisitLog, VisitLogService> {
    ...
    public BaseResult save(VisitLog entity) {
    ...
    public BaseResult page(PaginationDto paginationDto, VisitLog entity) {
