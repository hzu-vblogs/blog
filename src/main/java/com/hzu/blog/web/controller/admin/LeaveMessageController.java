...
public class LeaveMessageController extends AbstractController<LeaveMessage, LeaveMessageService> {


    @ModelAttribute
    public LeaveMessage entity(Long id){
        if (id!=null)
    ...
    public String list() {
        return "admin/leave-message-table";
    }
    ...
    public BaseResult save(LeaveMessage entity) {
    ...
    public BaseResult page(PaginationDto paginationDto, LeaveMessage entity) {
